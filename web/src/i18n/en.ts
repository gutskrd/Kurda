...
export const en = {
  ...
  'error.crash.body': 'This page ran into an unexpected problem. Your account and your progress are safe.',
  ...
  'shop.loadFailed': 'Couldn’t load the shop',
  'shop.gems': 'Gems',
  'shop.filter.all': 'Everything',
  'shop.filter.backgrounds': 'Backgrounds',
  'shop.filter.icons': 'Icons',
  'shop.searchPlaceholder': 'Search by name…',
  'shop.searchLabel': 'Search the shop',
  'shop.noMatches': 'Nothing matches that. Try a different word, or clear the filters.',
  'shop.profileBackgrounds': 'Profile Backgrounds',
  'shop.premiumIcons': 'Premium Icons',
  ...
  'shop.searchFriendsLabel': 'Search friends',
  'shop.nothingYet': 'Nothing here yet — check back soon.',
  'shop.owned': 'Owned',
  'shop.isYours': '{name} is yours. Equip it from Edit Profile.',
  'shop.onItsWay': '{name} is on its way to {to}.',
  'shop.subtitle': 'Buy profile backgrounds and premium icons with Zêr — for yourself, or as a gift for a friend.',
  'shop.show': 'Show',
  'shop.withinMyZer': 'Within my Zêr',
  'shop.buy': 'Buy',
  ...
  'rankings.shownOf': '{shown} of {total}',
  'rankings.thatsEveryone': 'That’s everyone — {total} ranked.',
  ...
  'rankings.unit.xp': 'XP',
  'rankings.youMarker': 'you',

  // ---- comments, the daily reward, the library and the blocklist -----
  ...
  'comments.deleteThis': 'Delete this comment',
  'comments.showOneReply': 'Show 1 reply',
  'comments.showReplies': 'Show {count} replies',
  'comments.posting': 'Posting…',
  'comments.submit': 'Comment',
  'daily.claimed': '+{amount} Zêr claimed!',
  'daily.comeBack': 'Come back tomorrow for more Zêr.',
  'daily.claim': 'Claim daily Zêr',
  'daily.claiming': 'Claiming…',
  'daily.claimedToday': 'Claimed today',
  'library.notFound': 'That post could not be found.',
  'library.allPoems': 'All poems',
  'library.allStories': 'All stories',
  'library.poem': 'Poem',
  'library.story': 'Story',
  'library.audio': 'Audio',
  'settings.blocked.loading': 'Loading your blocklist…',
