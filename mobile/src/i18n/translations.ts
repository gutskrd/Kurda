...
export type TranslationKey =
  ...
  | 'leagues.tier.silver'
  | 'leagues.tier.gold'
  | 'leagues.tier.sapphire'
  | 'leagues.tier.ruby'
  | 'leagues.tier.emerald'
  | 'leagues.tier.amethyst'
  | 'leagues.tier.pearl'
  | 'leagues.tier.obsidian'
  | 'leagues.tier.diamond'
  | 'leagues.tierName'
  | 'leagues.endsIn'
  | 'coursemap.strength'
  | 'coursemap.strengthDecayed'
  | 'streak.day'
  | 'streak.days'
  | 'username.rules'
  | 'library.kind.story'
  | 'library.kind.poem'
  | 'library.kind.stories'
  | 'library.kind.poems'
  | 'library.sort.newest'
...
const en: Catalog = {
  ...
  'library.kind.story': 'Story',
  'library.kind.poem': 'Poem',
  'streak.day': '{count} day',
  'streak.days': '{count} days',
  'username.rules': '3–{max} characters · letters, numbers, _ · you can change it once every 30 days.',
...
const ku: Catalog = {
  ...
  'library.sort.popular': 'Populer',
  'notifications.unreadLabel': 'Agahdarî, {count} nexwendî',
  'library.kind.story': 'Çîrok',
  'library.kind.poem': 'Helbest',
  'streak.day': '{count} roj',
  'streak.days': '{count} roj',
  'username.rules': '3–{max} tîp · herf, hejmar, _ · tu dikarî her 30 rojan carekê biguherînî.',
...
const de: Catalog = {
  ...
  'library.sort.popular': 'Beliebt',
  'notifications.unreadLabel': 'Mitteilungen, {count} ungelesen',
  'library.kind.story': 'Geschichte',
  'library.kind.poem': 'Gedicht',
  'streak.day': '{count} Tag',
  'streak.days': '{count} Tage',
  'username.rules': '3–{max} Zeichen · Buchstaben, Ziffern, _ · einmal alle 30 Tage änderbar.',
  'leagues.tier.bronze': 'Bronze',
...
const es: Catalog = {
  ...
  'library.sort.popular': 'Populares',
  'notifications.unreadLabel': 'Notificaciones, {count} sin leer',
  'library.kind.story': 'Relato',
  'library.kind.poem': 'Poema',
  'streak.day': '{count} día',
  'streak.days': '{count} días',
  'username.rules': '3–{max} caracteres · letras, números, _ · puedes cambiarlo una vez cada 30 días.',
...
const tr: Catalog = {
  ...
  'library.sort.popular': 'Popüler',
  'notifications.unreadLabel': 'Bildirimler, {count} okunmamış',
  'library.kind.story': 'Hikâye',
  'library.kind.poem': 'Şiir',
  'streak.day': '{count} gün',
  'streak.days': '{count} gün',
  'username.rules': '3–{max} karakter · harf, rakam, _ · 30 günde bir değiştirebilirsin.',
  'leagues.tier.bronze': 'Bronz',
...
const ar: Catalog = {
  ...
  'library.sort.popular': 'الرائج',
  'notifications.unreadLabel': 'الإشعارات، {count} غير مقروء',
  'library.kind.story': 'قصة',
  'library.kind.poem': 'قصيدة',
  'streak.day': '{count} يوم',
  'streak.days': '{count} يوم',
  'username.rules': '3–{max} حرفًا · حروف وأرقام و_ · يمكنك تغييره مرة كل 30 يومًا.',
...
const fr: Catalog = {
  ...
  'library.sort.popular': 'Populaires',
  'notifications.unreadLabel': 'Notifications, {count} non lues',
  'library.kind.story': 'Récit',
  'library.kind.poem': 'Poème',
  'streak.day': '{count} jour',
  'streak.days': '{count} jours',
  'username.rules': '3–{max} caractères · lettres, chiffres, _ · modifiable une fois tous les 30 jours.',
  'leagues.tier.bronze': 'Bronze',
...
const nl: Catalog = {
  ...
  'library.sort.popular': 'Populair',
  'notifications.unreadLabel': 'Meldingen, {count} ongelezen',
  'library.kind.story': 'Verhaal',
  'library.kind.poem': 'Gedicht',
  'streak.day': '{count} dag',
  'streak.days': '{count} dagen',
  'username.rules': '3–{max} tekens · letters, cijfers, _ · je kunt het één keer per 30 dagen wijzigen.',
...
const ckb: Catalog = {
  ...
  'library.sort.popular': 'بەناوبانگ',
  'notifications.unreadLabel': 'ئاگادارکردنەوەکان، {count} نەخوێندراو',
  'library.kind.story': 'چیرۆک',
  'library.kind.poem': 'هۆنراوە',
  'streak.day': '{count} ڕۆژ',
  'streak.days': '{count} ڕۆژ',
  'username.rules': '3–{max} پیت · پیت، ژمارە، _ · هەر 30 ڕۆژ جارێک دەتوانیت بیگۆڕیت.',
